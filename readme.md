# Система аутентификации на PHP с использованием MVC
...
2. Войдите в систему через /login используя:

    - Логин и пароль

    - Кнопку "Авторизоваться через VK"

3. После входа вы получите доступ к:

    - Личному кабинету (/dashboard)

    - Защищенной странице (/protected)

4. На защищенной странице:

    - Все пользователи видят текст

    - Пользователи VK видят дополнительное изображение
